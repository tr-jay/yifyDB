...
<div class="container">
  <div class="movie_poster_info flex-box no-m">
    ...
    <div class="movie_info">
      ...
      <a class="subtitles" href="https://yifysubtitles.org/movie-imdb/{imdb_id}" rel="noopener noreferrer nofollow" target="_blank">
        <img class="download_logo" src="/yifydb/assets/img/download-logo-white.png">Download Subtitles
      </a>
    </div>
  </div>
  ...
  <div class="download_btn flex-box no-m no-t">
    <a onclick="openDownloadModal()" class="download_btn_main"><img class="download_logo" src="/yifydb/assets/img/download-logo-white.png">Download</a>
  ...
  <div class="social_media_share flex-box">
    <a href="https://www.facebook.com/sharer/sharer.php?u={{{{site.my_domain}}}}{{{{page.url}}}}" class="social_media" target="_blank" rel="noopener noreferrer nofollow"><img class="facebook" src="/yifydb/assets/img/023-facebook.svg"></a>
    <a href="http://www.reddit.com/submit?url={{{{site.my_domain}}}}{{{{page.url}}}}" class="social_media" target="_blank" rel="noopener noreferrer nofollow"><img class="reddit" src="/yifydb/assets/img/072-reddit.svg"></a>
    <a href="https://twitter.com/intent/tweet?text={{{{site.my_domain}}}}{{{{page.url}}}}" class="social_media" target="_blank" rel="noopener noreferrer nofollow"><img class="twitter" src="/yifydb/assets/img/twitter.svg"></a>
    <a class="social_media copy-link-logo no-m no-t"><img class="copy-link" src="/yifydb/assets/img/link-symbol.svg"><span class="tooltiptext">Copy to clipboard</span></a>
