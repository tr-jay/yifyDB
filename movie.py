...
<div class="container">
  ...
  <div class="social_media_share flex-box">
    <a href="https://www.facebook.com/sharer.php?u={{{{site.my_domain}}}}{{{{page.url}}}}" class="social_media" target="_blank" rel="noopener noreferrer nofollow"><img class="facebook" src="/yifydb/assets/img/023-facebook.svg"></a>
